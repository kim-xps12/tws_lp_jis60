...
ビルドガイドは Web 版（[https://b-sky-lab.github.io/tws_lp_jis60/](https://b-sky-lab.github.io/tws_lp_jis60/)）を参照してください。ソースは [docs/build_guide/build_guide.md](docs/build_guide/build_guide.md) です。

ファームウェア（ZMKシールドモジュール）は [b-sky-lab/tws_lp_shield_module](https://github.com/b-sky-lab/tws_lp_shield_module) で管理されています。
