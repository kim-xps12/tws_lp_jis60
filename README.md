...
ビルドガイドは Web 版（[https://ar-kr.github.io/tws_lp_jis60/](https://ar-kr.github.io/tws_lp_jis60/)）を参照してください。ソースは [docs/build_guide/build_guide.md](docs/build_guide/build_guide.md) です。
